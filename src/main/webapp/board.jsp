	...
	<div class="container">
		<div class="row">
			<table class="table table-striped" style="text-align:center; border: 1px solid #dddddd">
				<thead>
					<tr>
						<th colspan="4" style="background-color: #eeeeee; text-align: center;"><font color="black">게시판</font></th>
					</tr>
					<tr>
						<th style="background-color: #eeeeee; text-align:center;"><font color="black">번호</font></th>
						<th style="background-color: #eeeeee; text-align:center;"><font color="black">제목</font></th>
						<th style="background-color: #eeeeee; text-align:center;"><font color="black">작성자</font></th>
