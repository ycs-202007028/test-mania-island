...
<body id="top">
  ...
  %>
	...
	<div style="padding: 60px 20px 40px 50px;">
		<img src=<%=img %> alt="크롤링부분" align="left" width="500" height="300"
			style="margin-right: 2%"> <span
			style="margin-top: 20px; font-size: 30px;"><b><%=title %></b></span>
		<br> <span style="font-size: 20px;"><%=content %></span>
		<!--<footer><a class="btn" href="######">크롤링부분</a></footer><br>-->
		<button id="go" align="right"
	...
	<div style="padding: 10px 20px 40px 50px;" id="form-commentInfo">
		...
		<input id="comment-input" placeholder="댓글 남기기 어때?"
			style="width: 820px; height: 70px; font-size: 25px;"></input>
